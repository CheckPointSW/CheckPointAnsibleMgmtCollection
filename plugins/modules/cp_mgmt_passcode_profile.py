...
def main():
    argument_spec = dict(
        ...
        min_passcode_length=dict(type='int'),
        require_alphanumeric_passcode=dict(type='bool'),
        min_passcode_complex_characters=dict(type='int'),
        ...
        max_passcode_failed_attempts=dict(type='int'),
        enable_passcode_history=dict(type='bool'),
        passcode_history=dict(type='int'),
