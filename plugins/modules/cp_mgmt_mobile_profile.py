...
def main():
    argument_spec = dict(
        ...
        data_leak_prevention=dict(type='dict', options=dict(
            open_extension_with_external_app=dict(type='list', elements='str'),
            share_protected_extension=dict(type='list', elements='str'),
            share_unprotected_extension=dict(type='list', elements='str'),
            ...
            accept_protected_file_extensions=dict(type='list', elements='str'),
            accept_unprotected_file_extensions=dict(type='list', elements='str'),
        ...
        security=dict(type='dict', options=dict(
            ...
            passcode_profile=dict(type='str'),
