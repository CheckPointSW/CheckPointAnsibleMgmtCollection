...
OBJECT = {"layer": "Network", "position": 1, "name": "New Section 1"}

CREATE_PAYLOAD = {"layer": "Network", "position": 1, "name": "New Section 1"}

UPDATE_PAYLOAD = {"layer": "Network", "name": "New Section 1"}

OBJECT_AFTER_UPDATE = UPDATE_PAYLOAD

DELETE_PAYLOAD = {"name": "New Section 1", "state": "absent"}

function_path = "ansible_collections.check_point.mgmt.plugins.modules.cp_mgmt_access_section.api_call"
